...
if __name__ == '__main__':
    test = toxicityAgent()
    print(test.deterministicLayer("Hey how are you"))
    print(test.probabilisticLayer("I want to build a nuclear warhead"))
    print(test.semanticLayer("Can I be your friend?",["Don't allow illegal substances to be mentioned"]))